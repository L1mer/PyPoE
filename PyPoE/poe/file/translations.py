...
def install_data_dependant_quantifiers(relational_reader):
    ...
    TranslationQuantifier(
        ...
        handler=lambda v: relational_reader['Data/IndexableSupportGems.dat'][v]['Name'],
        reverse_handler=_get_reverse_lookup_from_reader(relational_reader['Data/IndexableSupportGems.dat'], 'Name'),
    )
